...
const VitalTask = () => {
  ...
  return (
    <div className="bg-gray-100 h-screen">
      ...
      {/* Vital Task */}
      <Link to="/vital-task" className="flex items-center space-x-4 w-full px-4 py-2 bg-black rounded-md">
        <FaBell className="text-white text-xl" />
        <p className=" text-md font-medium text-white">Vital Task</p>
      </Link>
...
<div className="w-[60%] h-full bg-white rounded-[20px] p-4 shadow-md">
  ...
  <ol className="text-gray-400 text-sm mt-4 list-decimal list-inside">
